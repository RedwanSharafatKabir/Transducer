...
public class LightSensorDatabaseHelper extends SQLiteOpenHelper {
    static final String DATABASE_NAME = "LightSensor.db";
    static final String TABLE_NAME = "LightSensor_Details";
    ...
    public LightSensorDatabaseHelper(@Nullable Context context) {
    ...
    // Insert data into LightSensor.db database
    ...
    // Retrieve data from LightSensor.db database
    ...
    // Count row numbers of LightSensor_Details table
    ...
    // Delete data from LightSensor.db database
